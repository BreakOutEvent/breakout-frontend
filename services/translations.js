...
module.exports = {
  SELECTION: {
    ...
    PARTICIPANT: {
      ...
      en: 'You would like to take part in BreakOut 2016 and embark on your own adventure? Follow these steps to sign up'
    },
    SPONSOR_H: {
      de: 'Sponsor',
      en: 'Sponsor'
  ...
  'TEAM-CREATE': {
    ...
    PLACEHOLDER_EMAIL: {
      ...
      en: 'travelcompanion@adventure.eu'
    },
    LABEL_CITY: {
      de: 'Startstadt',
      en: 'Starting city'
  ...
  IMPRINT: {
    ...
    INFORMATION_TMG_HEADING: {
      de: 'Angaben gemäß § 5 TMG:'
    },
    ADDRESS: {
      de: '<p>Robert Darius<br>c/o Impact Hub Munich GmbH<br>Gotzinger Straße 8<br>81371 München</p>'
    },
    CONTACT_HEADING: {
      de: 'Kontakt:'
    },
    CONTACT: {
      de: '<a href="mailto:event@break-out.org">event@break-out.org</a>'
    },
    RSTV_HEADING: {
