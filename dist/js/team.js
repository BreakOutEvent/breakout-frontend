...
var Masonry = __webpack_require__(757);
var Plyr = __webpack_require__(762);
var lightbox = __webpack_require__(763);
...
$(window).on('load', function () {
  ...
  if ($('#teamPosts').length > 0) {
    ...
    $.post('/team/authenticated').success(function () {
    ...
    $('#newPost').on('submit', function (e) {
      ...
      $.ajax({
        ...
        console.log(err);
        $('#bo-post-result').html('<div class="alert alert-danger">Speichern fehlgeschlagen!</div>');
        window.msnry.layout();
      });
    });
    ...
    $('.bo-card-actions-like').click(function (e) {
      ...
      $.post('/team/like', { postingId: $button.data('id') }).success(function (data) {
  ...
  $('.bo-replace-hashtags').each(function () {
    ...
    wrapped = wrapped.replace(/(#[\S]*)/g, function (a, b) {
      return '<a href=\'/post/hashtag/' + b.slice(1) + '\'>' + b + '</a>';
    });
    $(this).html(wrapped);
  });
...
function searchForString(string) {
  ...
  for (var i = 0; i < d.length; i++) {
    var c = d[i];
    if (c.name.toLowerCase().indexOf(string) > -1 || String(c.id).toLowerCase().indexOf(string) > -1) {
      r.push(c);
    } else {
      $.each(c.members, function (i, m) {
        if (m.firstname.toLowerCase().indexOf(string) > -1 || m.lastname.toLowerCase().indexOf(string) > -1) {
          r.push(c);
        }
      });
    }
...
;(function(root, factory) {
    ...
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        // AMD
        !(__WEBPACK_AMD_DEFINE_RESULT__ = (function() { factory(root, document) }).call(exports, __webpack_require__, exports, module),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else {
