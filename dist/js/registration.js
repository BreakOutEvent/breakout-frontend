...
$(document).ready(function () {
  ...
  $('#forgotPW').click(function () {
    ...
    if (email === '') {
      $('#error').html('<div class="alert alert-danger">' + 'You must enter the email address you registered with, to reset your password!</div>');
    } else {
      ...
      $.post('/request-pw-reset', {
        ...
        $('#success').html('<div class="alert alert-success">' + 'An email with instructions to reset your password was sent to: ' + email + '</div>');
      }).error(function (err) {
  ...
  if ($('#registerForm').length > 0) {
    ...
    $('#registrationForm').on('submit', function (e) {
      ...
      if (sanityCheck('registrationForm')) {
        ...
        if (!($('#profilePic').length && $('#profilePic')[0].files && $('#profilePic')[0].files[0])) {
    ...
    $('#teamForm').on('submit', function (e) {
      ...
      if (sanityCheck('teamForm')) {
        ...
        if (!($('#profilePic')[0] && $('#profilePic')[0].files && $('#profilePic')[0].files[0])) {
        ...
        $.ajax({
          ...
          $('#feedback').html('<div class="alert alert-danger">' + err.responseJSON.error.message + '</div>');
        }).always(function () {
          toggleLoading('#mainCTA');
        });
      }
    ...
    $('#inviteForm').on('submit', function (e) {
      ...
      if (sanityCheck('inviteForm')) {
        ...
        toggleLoading('#mainCTA');
        $.post('/invite', values).success(function () {
          $('#feedback').html('<div class="alert alert-success">' + 'Erfolgreich eingeladen!</div>');
          $('#email').val('');
        }).error(function (err) {
    ...
    $('.joinLinkTeam').click(function () {
      ...
      toggleLoading('#mainCTA');
      $.post('/team-invite', data).success(function (res) {
        window.location.href = res.nextUrl;
      }).error(function (err) {
        $('#feedback').html('<div class="alert alert-danger">' + err.responseJSON.error + '</div>');
      }).always(function () {
