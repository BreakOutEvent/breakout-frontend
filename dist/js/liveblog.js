...
$(document).ready(function () {
  ...
  function updateCounter() {
    ...
    counter.time.minutes = Math.floor((counter.value - counter.time.days * 24 * 60 * 60 * 1000 - counter.time.hours * 60 * 60 * 1000) / (60 * 1000));
    counter.time.seconds = Math.floor((counter.value - counter.time.days * 24 * 60 * 60 * 1000 - counter.time.hours * 60 * 60 * 1000 - counter.time.minutes * 60 * 1000) / 1000);
