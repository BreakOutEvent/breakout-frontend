...
$(document).ready(function () {
  ...
  $('#participant_form').submit(function (e) {
    ...
    if (sanityCheck('participant_form')) {
      ...
      $.ajax({
        ...
        console.log(err);
        $('#result_participant').html('<div class="alert alert-danger">Speichern fehlgeschlagen!</div>');
      }).always(function () {
        toggleLoading('#participant_CTA');
      });
    }
  ...
  $('#team_form').submit(function (e) {
    ...
    if (sanityCheck('team_form')) {
      ...
      if (!($('#teamPic').length && $('#teamPic')[0].files && $('#teamPic')[0].files[0])) {
  ...
  $('#sponsor_form').submit(function (e) {
    ...
    if (sanityCheck('sponsor_form')) {
      ...
      $.ajax({
        ...
        $('#result_sponsor').html('<div class="alert alert-success">Erfolgreich gespeichert!</div>');
      }).error(function (err) {
        console.log(err);
        $('#result_sponsor').html('<div class="alert alert-danger">Speichern fehlgeschlagen!</div>');
      }).always(function () {
        toggleLoading('#sponsor_CTA');
      });
    }
