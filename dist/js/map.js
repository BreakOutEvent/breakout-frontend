...
var drawRoute = function drawRoute(teams) {
...
function makeContent(team) {
  var contentstring = '<div id="content">' + '<div id="siteNotice">' + '</div>' + '<h4 id="firstHeading" class="firstHeading"><a href="/team/' + team.id + '">' + team.name + '</a></h4>';
