...
var sanityCheck = __webpack_require__(28).sanityCheck;
...
$(document).ready(function () {
  ...
  function output(text, limit, outputHTML, estimate) {
    return function () {
      var string = 'Ein Team hat 2015 im Durchschnitt 800km zur\xFCck gelegt. Bei ' + text.val() + '\u20AC\n      pro Kilometer erg\xE4be das eine Spendensummme von ' + Math.round(800 * text.val()) + '\u20AC.';
      if (limit.val() > 0 && limit.val() < Math.round(800 * text.val())) {
        string += ' Durch das Limit wird die Spendensumme\n      auf maximal ' + Math.round(limit.val()) + '\u20AC beschr\xE4nkt.';
      }
  ...
  $('.bo-btn-edit').click(function () {
    var data = $(this).parent().parent().find('td').map(function () {
      return $(this).html();
    });
  ...
  $('#selfSponsoringModal').submit(function (e) {
    ...
    if (sanityCheck('selfSponsoringModal')) {
      ...
      $.ajax({
        ...
        console.log(err);
        $('#selfResult').html('<div class="alert alert-danger">Speichern fehlgeschlagen!</div>');
        toggleLoading('#bo-self-cta');
      });
    }
  });

  $('#bo-add-challenge-model-btn').click(function (e) {
    alert('Eintragen von Sponsoren ist nach dem Event nicht mehr möglich');
    e.stopImmediatePropagation();
  });

  $('#bo-add-sponsoring-model-btn').click(function (e) {
    alert('Eintragen von Challenges ist nach dem Event nicht mehr möglich');
    e.stopImmediatePropagation();
  });

  $('#bo-add-offline-sponsoring-model-btn').click(function (e) {
    alert('Eintragen von Sponsoren ist nach dem Event nicht mehr möglich');
    e.stopImmediatePropagation();
  });
  ...
  $('#editSponsoringModal').submit(function (e) {
    ...
    if (sanityCheck('editSponsoringModal')) {
      ...
      $.ajax({
        ...
        console.log(err);
        $('#editResult').html('<div class="alert alert-danger">Speichern fehlgeschlagen!</div>');
  ...
  $('#addSponsoringModal').submit(function (e) {
    ...
    if (sanityCheck('addSponsoringModal')) {
      ...
      $.ajax({
        ...
        console.log(err);
        $('#addResult').html('<div class="alert alert-danger">Speichern fehlgeschlagen!</div>');
  ...
  $('.bo-btn-accept').click(function () {
    ...
    $.post('/settings/sponsoring/accept', {
      ...
      console.log(err);
      $('#result_in').html('<div class="alert alert-danger">Annehmen fehlgeschlagen!</div>');
  ...
  $('.bo-btn-decline').click(function () {
    ...
    $.post('/settings/sponsoring/reject', {
      ...
      console.log(err);
      $('#result_in').html('<div class="alert alert-danger">Ablehnen fehlgeschlagen!</div>');
      toggleLoading(button);
    });
  });
  ...
  $('.bo-btn-delete').click(function () {
    ...
    $.post('/settings/sponsoring/delete', {
      ...
      console.log(err);
      $('#result_in').html('<div class="alert alert-danger">Löschen fehlgeschlagen!</div>');
      toggleLoading(button);
    });
  });
  ...
  $('#addChallengeForm').submit(function (e) {
    ...
    if (sanityCheck('addSponsoringModal')) {
      ...
      $.ajax({
        ...
        console.log(err);
        $('#addChallengeResult').html('<div class="alert alert-danger">Speichern fehlgeschlagen!</div>');
