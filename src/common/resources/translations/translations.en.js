...
module.exports = {
  ...
  "PAYMENT": {
    ...
    "DESCRIPTION_4": "So the total amount per term is 50€ (20€ Registration per person + 15€ Deposit). For a succesful registration the total amount has to be transferred by 24th May 2021. Please use the <strong>mentioned purpose</strong> and the following bank account:",
