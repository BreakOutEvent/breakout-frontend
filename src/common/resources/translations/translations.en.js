...
module.exports = {
  "client": {
    ...
    "sponsor": {
      ...
      "addChallenge": {
        ...
        "suggestions": {
          "0": 'Swim through a river',
          "1": 'Walk 1 km backwards',
          "2": 'Do a handstand',
          ...
          "7": 'do the sun salutation together during sunrise'
        },
    ...
    "create_or_join_team": {
      ...
      "no_invitations": "There are no team invitations for you.",
      "team_name": {
        "label": "team name",
      ...
      "postaddress": {
        "label": "If you want to start in München, please write us: \"Start and Pick up at the starting location\". \nIf you want to start from home, please tell us the address (name, street + no., zip code + city) where your starterkit will be sent to (shipping date approx. 20.06.22, shipping only available in Germany)"
      }
    },
    "team_settings": {
    ...
    "cookie_consent": {
      "description": "We're using cookies to improve your user experience.",
      "accept": "Yes sure, no problem",
      "decline": "Decline"
    }
  },
  "BECOME_SPONSOR": {
  ...
  "PAYMENT": {
    ...
    "DESCRIPTION_4": "So the total amount per term is 50€ (15€ Registration per person + 20€ Deposit). For a succesful registration the total amount has to be transferred by 31st May 2022. Please use the <strong>mentioned purpose</strong> and the following bank account:",
  ...
  "TEAM-DETAIL": {
    ...
    "TEAM_FEE_DESCRIPTION": "To complete your registration, please transfer your registration fee as soon as possible. We can only activate your team once we've received the registration fee. Please transfer the fee by latest May 31st 2022 so that we can equip you with a t-shirt and your starter kit.",
