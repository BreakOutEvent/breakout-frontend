...
module.exports = {
  "client": {
    ...
    "role_select": {
      ...
      "participant_text": "Hier kannst du bei BreakOut 2018 teilnehmen und ein Team erstellen oder einem Team beitreten. Als Teilnehmer wird pro Team eine Startgebühr von 60€ fällig.",
    ...
    "create_team": {
      ...
      "invalid_invite_email": "Dein Team wurde erstellt, aber die Emailadresse deines Teampartner ist ungültig. Upps! Du kannst jederzeit auf deinem Profil unter Teameinstellungen weitere Einladungen zu deinem Team versenden"
    },
    "join_team": {
    ...
    "create_team_success": {
      ...
      "title": "Dein Team wurde erfolgreich erstellt! Lasset das Abenteuer beginnen!",
    ...
    "join_team_success": {
      ...
      "description": "Herzlichen Glückwunsch. Du und dein Teampartner habt euch erfolgreich für BreakOut 2018 registriert. Bitte überweist nun die Teilnahmegebühr mit dem unten stehenden Verwendungszweck bis zum 16. Mai 2018.",
  ...
  "SELECTION": {
    ...
    "PARTICIPANT": "Du willst Dein eigenes Abenteuer erleben und an BreakOut 2018 teilnehmen? Dann geht's hier weiter zur Anmeldung.",
    "SPONSOR_H": "Sponsor",
    "SPONSOR": "Sie wollen Ihr favorisiertes Team bei BreakOut 2018 unterstützen und damit etwas Gutes tun? Dann hier klicken und als Sponsor anmelden.",
  ...
  "REGISTER": {
    ...
    "INVITE_TEXT_2": " Du wurdest von BLANK eingeladen mit ihm/ihr an BreakOut teilzunehmen. Melde Dich jetzt an und Ihr seid zusammen im Team. ",
    "INVITE_TEXT_3": ".",
  ...
  "PROFILE": {
    ...
    "PAYMENT_INFO": "Die Zahlung Deines Eventbeitrags (30,- €) ist noch nicht bei uns eingetroffen. Bitte überweise den Betrag bis zum 16. Mai 2018, um am Event teilzunehmen.",
  ...
  "MAINTENANCE": {
    ...
    "DESCRIPTION": "Hoppla! Wir führen aktuell geplante Wartungsarbeiten durch. Bitte versuche es später noch einmal. Merci für Dein Verständnis."
  },
  "FOOTER": {
    "H_SPONSOR": "Partner von BreakOut",
    "SPONSOR": "BreakOut wird unterstützt von STA Travel, einem weltweiten Anbieter von Flugtickets, Hotels, Hostels und work & travel-Programmen, und der Social Entrepreneurship Akademie in München, die gezielt soziale Gründungsprojekte fördert.",
  ...
  "SPONSORING": {
    ...
    "ADD_CHALLENGE_MODAL_CONTENT": "Hier können Sie kleine und große Aufgaben an Ihre Favorit-Teams stellen und deren Erfüllung mit einem Geldbetrag belohnen.",
  ...
  "LIVEBLOG": {
    ...
    "BTN": "Zur Anmeldung",
    "NEWSLETTER": "Sei bei BreakOut 2018 dabei...",
    "MEDIA_LOADING": "Medien verarbeiten noch",
    "MEDIA_ABORTED": "Medien hochladen fehlgeschlagen",
    "COMMENTS": "Kommentare",
    "SEND": "SEND",
